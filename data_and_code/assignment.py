...
def simulate_bushfire_stochastic(initial_bushfire, steps,vegetation_type, vegetation_density,wind_speed):
    """1. Function purpose: stochastically simulate fire spreading for a number of steps.
          It taskes fire_risk of the cell into consideration.
       2. Restrictions:
          a. input (initial_bushfire, vegetation_type, vegetation_density,wind_speed) which is lists of
...
if __name__ == '__main__':
    ...
    # #
    # # final_bushfire =simulate_bushfire(initial_bushfire, vegetation_type, vegetation_density, 80)
    ...
    # # final_bushfire = simulate_bushfire(initial_bushfire, vegetation_type, vegetation_density, 60)
    # # bushfire_b =final_bushfire
    # print(compare_bushfires(bushfire_b, final_bushfire))
    ...
    stochastic_bush_fire = simulate_bushfire_stochastic(initial_bushfire, 94, vegetation_type, vegetation_density, wind_speed)
    show_bushfire(stochastic_bush_fire)
    show_bushfire(final_bushfire)
    print(compare_bushfires(stochastic_bush_fire, final_bushfire))
